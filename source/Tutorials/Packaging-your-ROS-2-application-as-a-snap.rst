...
- **Container solution**: Snaps bundle your application including all the necessary dependencies and assets in one package including ROS 2. Your application is then easily installable on dozens of Linux distributions and across distro versions.
